"""W41-A Idempotency-Integration-Tests fuer opera-pms book_room [CRUX-MK]."""
...
from src.opera_adapter import OperaConnector  # noqa: E402
...
@pytest.fixture
def adapter():
    a = OperaConnector(sandbox_mode=True)
